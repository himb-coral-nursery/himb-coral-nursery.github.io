...
<div class="full-width-section">
  <div class="nursery-live-data" style="margin: 40px auto; padding: 25px; background: #fdfdfd; border: 1px solid #eee; border-radius: 12px; text-align: center; max-width: 500px;">
    ...
    <a href="https://aqualink.org/sites/1042" class="btn" style="display: inline-block; background: #10616A; color: white; padding: 12px 24px; border-radius: 6px; text-decoration: none; font-family: 'Nursery-Body', sans-serif; font-size: 1rem;">
      View Live Buoy Data →
    </a>
